...
export const ui = {
  zh: {
    ...
    'energy.tagline': '绿色甲醇驱动的零碳能源解决方案',
    ...
    'energy.why6.title': '阶梯式 ISCC 认证路线',
  ...
  ja: {
    ...
    'energy.tagline': 'グリーンメタノール駆動のゼロカーボンエネルギーソリューション',
    ...
    'energy.why6.title': '段階的 ISCC 認証ロードマップ',
  ...
  en: {
    ...
    'energy.tagline': 'Green-Methanol-Driven Zero-Carbon Energy Solutions',
    ...
    'energy.why6.title': 'Staged ISCC Certification Roadmap',
